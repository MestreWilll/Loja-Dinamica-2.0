...
local function constructNew_frmLojinha()
    ...
    obj:setTitle("Loja Dinamica 2.0");
    obj:setAlign("client");

    obj.frmLojaDinamica = GUI.fromHandle(_obj_newObject("form"));
    obj.frmLojaDinamica:setParent(obj);
    obj.frmLojaDinamica:setName("frmLojaDinamica");
    obj.frmLojaDinamica:setAlign("client");

    obj.Pag1 = GUI.fromHandle(_obj_newObject("layout"));
    obj.Pag1:setParent(obj.frmLojaDinamica);
    ...
    function obj:destroy() 
        ...
        if self.frmLojaDinamica ~= nil then self.frmLojaDinamica:destroy(); self.frmLojaDinamica = nil; end;
